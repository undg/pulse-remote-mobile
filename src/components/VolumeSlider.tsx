    ...
    <View style={[styles.container, { backgroundColor: colors.surface }]}>
      <View style={styles.headerRow}>
        <Pressable
          ...
          style={[
            ...
            props.muted && { backgroundColor: colors.error },
          ]}
        >
          <Text style={[styles.muteText, { color: colors.text }]}>
            {props.muted ? "🔇" : "🔊"}
          </Text>
        </Pressable>
        <Pressable
          style={styles.labelArea}
          onLongPress={props.onLongPressHeader}
          delayLongPress={150}
        >
      ...
      <Slider
        ...
        onSlidingComplete={(v: number | number[]) =>
          props.onCommit?.(Array.isArray(v) ? v[0] : v)
        }
